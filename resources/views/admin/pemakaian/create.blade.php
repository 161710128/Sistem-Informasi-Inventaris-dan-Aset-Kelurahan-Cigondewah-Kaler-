...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Membuat data Pemakaian Barang</h1>
</div>

<div class="col-lg-8">
    <form action="/admin/transaksi/pemakaian-barang/" method="post" class="mb-5">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control @error('tgl_pemakaian') is-invalid @enderror" id="tgl_pemakaian" name="tgl_pemakaian" value="{{ @old('tgl_pemakaian') }}">
            @error('tgl_pemakaian')
