...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Membuat data Peminjaman Barang</h1>
</div>

<div class="col-lg-8">
    <form action="/admin/transaksi/peminjaman-barang/" method="post" class="mb-5">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control @error('tgl_peminjaman') is-invalid @enderror" id="tgl_peminjaman" name="tgl_peminjaman" value="{{ @old('tgl_peminjaman') }}">
