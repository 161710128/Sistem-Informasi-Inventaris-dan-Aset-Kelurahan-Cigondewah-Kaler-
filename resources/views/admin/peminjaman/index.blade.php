...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="h2">Halaman Data Peminjaman Barang</h1>
</div>
...
<div class="table-responsive col-lg-10">
    <a href="/admin/transaksi/peminjaman-barang/create" class="btn btn-primary mb-3"><span data-feather="file-plus"></span></a>
      ...
      <table class="table table-striped table-sm">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="/admin/transaksi/peminjaman-barang/{{ $peminjaman->slug }}" class="badge bg-info"><span data-feather="eye"></span></a>
              <a href="/admin/transaksi/peminjaman-barang/{{ $peminjaman->slug }}/edit" class="badge bg-warning"><span data-feather="edit"></span></a>
              <form action="/admin/transaksi/peminjaman-barang/{{ $peminjaman->slug }}" method="post" class="d-inline">
                @csrf
                @method('delete')
