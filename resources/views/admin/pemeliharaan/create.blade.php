...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Membuat data Pemeliharaan Barang</h1>
</div>

<div class="col-lg-8">
    <form action="/admin/transaksi/pemeliharaan-barang/" method="post" class="mb-5">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control @error('tgl_pemeliharaan') is-invalid @enderror" id="tgl_pemeliharaan" name="tgl_pemeliharaan" value="{{ @old('tgl_pemeliharaan') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('biaya_pemeliharaan') is-invalid @enderror" id="biaya_pemeliharaan" name="biaya_pemeliharaan" autofocus value="{{ @old('biaya_pemeliharaan') }}" >
